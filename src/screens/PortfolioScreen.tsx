  ...
  return (
    ...
    >
      ...
      <View style={{ padding: 10 }}>
        <Text style={{ fontSize: 13, fontWeight: '700', color: C.textPrimary, marginBottom: 5, fontFamily: F.base }} numberOfLines={1}>
          {item.title}
        </Text>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 4, marginBottom: 6 }}>
          <View style={{ backgroundColor: color + '20', borderRadius: R.sm, paddingHorizontal: 6, paddingVertical: 2, borderWidth: 1, borderColor: color + '30' }}>
            <Text style={{ fontSize: 10, fontWeight: '700', color, fontFamily: F.base }}>{SERVICE_LABELS[item.serviceType]}</Text>
          </View>
        </View>
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
          ...
          {item.location && (
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 3 }}>
              ...
              <Text style={{ fontSize: 11, color: C.textSecondary, fontFamily: F.base }} numberOfLines={1}>{item.location}</Text>
            </View>
          )}
        </View>
      </View>
          ...
          <View style={{ flexDirection: 'row', gap: 10 }}>
            {[
              ...
              <View key={s.label} style={{
                ...
                <Text style={{ color: C.textPrimary, fontWeight: '800', fontSize: 16, marginTop: 4, fontFamily: F.base }}>{s.value}</Text>
                <Text style={{ color: C.textSecondary, fontSize: 11, fontFamily: F.base }}>{s.label}</Text>
              </View>
            ))}
          </View>
        </View>
        ...
        {featured.length > 0 && (
          <View style={{ paddingTop: 20, paddingBottom: 4 }}>
            <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: S.md, marginBottom: 12 }}>
              ...
              <Text style={{ fontSize: 15, fontWeight: '800', color: C.textPrimary, fontFamily: F.base }}>Em Destaque</Text>
            </View>
              ...
              {featured.map((item) => (
                ...
                >
                  ...
                  <View style={{ padding: 10 }}>
                    ...
                    <Text style={{ fontSize: 11, color: C.textSecondary, marginTop: 2, fontFamily: F.base }}>{item.location}</Text>
                  </View>
                </TouchableOpacity>
              ))}
            </ScrollView>
        ...
        <View style={{ padding: S.md }}>
          ...
          {filtered.length > 0 ? (
            ...
            <View style={{ alignItems: 'center', paddingVertical: 64 }}>
              ...
              <Text style={{ fontSize: 16, fontWeight: '700', color: C.textPrimary, marginTop: 4, fontFamily: F.base }}>Nenhum projeto</Text>
              <Text style={{ fontSize: 13, color: C.textSecondary, marginTop: 4, fontFamily: F.base }}>Tente outro filtro</Text>
            </View>
          )}
        </View>
      </ScrollView>
